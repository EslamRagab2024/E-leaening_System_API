...
namespace E_leaening_System.Controllers
{
    ...
    [ApiController]
    public class TheQuizesController : ControllerBase
    {
        private readonly IRepository<TheQuizzes> theQuizzesRepository;
        private readonly IMapper mapper;
        private readonly UserManager<ApplicationUser> userManager;

        public TheQuizesController(IRepository<TheQuizzes> theQuizzesRepository, UserManager<ApplicationUser> userManager, IMapper mapper)
        {
